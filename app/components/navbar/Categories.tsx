...
export const categories=[
    ...
    },
    {
        label:'Cave',
        icon:GiCaveEntrance,
        description:'This property is inside cave!'
    },
    {
        label:'Desert',
        icon:GiCactus,
...
const Categories=()=>{
    ...
    //since we only want to show category boxes on the homepage, we will use the usePathname hook to get the current pathname
